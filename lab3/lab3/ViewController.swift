...
class ViewController: UIViewController {
    ...
    @IBAction func fontSlider(_ sender: UISlider) {
        ...
        self.picLabel.font = UIFont.systemFont(ofSize: CGFloat(sliderValue))
        self.picLabel.textColor = UIColor(red:CGFloat(sliderValue / 35), green: CGFloat(sliderValue / 20), blue:CGFloat(sliderValue / 25), alpha:1.00)
